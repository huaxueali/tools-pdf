...
from pdf_model_comparison_pearson_vii import compare_peak_models
...
def main():
    ...
    parser.add_argument("--curve-data-dir", default="model_curve_data", help="Directory for separate curve-data DAT files")
    parser.add_argument("--curve-data-prefix", default="peak_fit_curve", help="Prefix for curve-data DAT files")
    ...
    results = compare_peak_models(
        ...
        curve_data_dir=input_file.parent / args.curve_data_dir,
        curve_data_prefix=args.curve_data_prefix,
    ...
    for res in results:
        print(
            ...
            f"curve_data = {res['curve_data_file']}"
        )
